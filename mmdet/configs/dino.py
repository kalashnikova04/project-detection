...
from mmdet.utils import AvoidCUDAOOM, OptConfigType
...
class DINO(DeformableDETR):
    ...
    def forward_transformer(
        ...
        encoder_inputs_dict["spatial_shapes"] = encoder_inputs_dict[
            "spatial_shapes"
        ].to(torch.long)
        # print(encoder_inputs_dict['feat'], encoder_inputs_dict['feat'].size())
        # print(encoder_inputs_dict['feat_mask'], encoder_inputs_dict['feat_mask'].size())
        # print(encoder_inputs_dict['feat_pos'], encoder_inputs_dict['feat_pos'].size())
        # print(encoder_inputs_dict['spatial_shapes'])
